...
#Bebeku
if [[ $EUID -ne 0 ]]; then
	echo "ERROR! Run this script with root rights!"
	exit 1
fi
...
function scanoutput() {
  ...
  echo " |_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_| "
    echo -e $white " "
    echo -e $white"	[$okegreen"1"$white]$okegreen  OUTPUT SCAN IN XML FORMATS  "
    echo -e $white"	[$okegreen"2"$white]$okegreen  OUTPUT SCAN IN HTML FORMATS "
    echo -e $white"	[$okegreen"3"$white]$okegreen  OUTPUT SCAN IN NORMAL FORMATS  "
    ...
    echo -n -e $red'  \033[4minfinite667@Meoong:\033[0m>> '; tput sgr0 #insert your choice
           ...
           if test $DrS == '1'
               then
                 echo
        	 echo -ne $cyan"  Path Location: /RedEyeMap/Output/"
                 echo
...
function brutense	() {
	...
	echo "                                                   ";
	    ...
	    echo -e $white " "
	    echo -e $white"	[$okegreen"1"$white]$cyan  afp-brute  "
	    echo -e $white"	[$okegreen"2"$white]$cyan  ajp-brute "
	    echo -e $white"	[$okegreen"3"$white]$cyan  backorifice-brute  "
	    echo -e $white"	[$okegreen"4"$white]$cyan  cassandra-brute "
	    echo -e $white"	[$okegreen"5"$white]$cyan  cics-enum "
	    echo -e $white"	[$okegreen"6"$white]$cyan  cics-user-enum "
	    echo -e $white"	[$okegreen"7"$white]$cyan  citrix-brute-xml"
	    echo -e $white"	[$okegreen"8"$white]$cyan  cvs-brute  "
	    echo -e $white"	[$okegreen"9"$white]$cyan  cvs-brute-repository "
...
clear
	echo
	echo
  echo -e $white"	[$okegreen"1"$white]$cyan ajp-auth "
  echo -e $white"	[$okegreen"2"$white]$cyan creds-summary	"
  echo -e $white"	[$okegreen"3"$white]$cyan domcon-cmd	"
  echo -e $white"	[$okegreen"4"$white]$cyan domino-enum-users	"
  echo -e $white"	[$okegreen"5"$white]$cyan ftp-anon	"
  echo -e $white"	[$okegreen"6"$white]$cyan http-auth	"
  echo -e $white"	[$okegreen"7"$white]$cyan http-barracuda-dir-traversal	"
  echo -e $white"	[$okegreen"8"$white]$cyan http-config-backup	"
  echo -e $white"	[$okegreen"9"$white]$cyan http-default-accounts	"
...
clear
  echo
  echo
  echo -e $white"	[$okegreen"1"$white]$cyan broadcast-ataoe-discover	"
  echo -e $white"	[$okegreen"2"$white]$cyan broadcast-avahi-dos	"
  echo -e $white"	[$okegreen"3"$white]$cyan broadcast-bjnp-discover "
  echo -e $white"	[$okegreen"4"$white]$cyan broadcast-db2-discover	"
  echo -e $white"	[$okegreen"5"$white]$cyan broadcast-dhcp-discover	"
  echo -e $white"	[$okegreen"6"$white]$cyan broadcast-dhcp6-discover	"
  echo -e $white"	[$okegreen"7"$white]$cyan broadcast-dns-service-discovery	"
  echo -e $white"	[$okegreen"8"$white]$cyan broadcast-dropbox-listener	"
  echo -e $white"	[$okegreen"9"$white]$cyan broadcast-eigrp-discovery	"
...
clear
  echo
  echo
  echo -e $white"	[$okegreen"1"$white]$cyan afp-path-vuln "
  echo -e $white"	[$okegreen"2"$white]$cyan clamav-exec   "
  echo -e $white"	[$okegreen"3"$white]$cyan distcc-cve2004-2687  "
  echo -e $white"	[$okegreen"4"$white]$cyan ftp-proftpd-backdoor "
  echo -e $white"	[$okegreen"5"$white]$cyan ftp-vsftpd-backdoor "
  echo -e $white"	[$okegreen"6"$white]$cyan http-adobe-coldfusion-apsa1301 "
  echo -e $white"	[$okegreen"7"$white]$cyan http-avaya-ipoffice-users "
  echo -e $white"	[$okegreen"8"$white]$cyan http-awstatstotals-exec "
  echo -e $white"	[$okegreen"9"$white]$cyan http-axis2-dir-traversal "
...
function fuzzer () {
  ...
  echo
  echo
  echo -e $white"	[$okegreen"1"$white]$cyan File dns-fuzz "
  echo -e $white"	[$okegreen"2"$white]$cyan File http-form-fuzzer	"
...
function malware () {
  ...
  echo
  echo
  echo -e $white"	[$okegreen"1"$white]$cyan auth-spoof	"
  echo -e $white"	[$okegreen"2"$white]$cyan dns-zeustracker	"
  echo -e $white"	[$okegreen"3"$white]$cyan ftp-proftpd-backdoor	"
  echo -e $white"	[$okegreen"4"$white]$cyan ftp-vsftpd-backdoor	"
  echo -e $white"	[$okegreen"5"$white]$cyan http-google-malware	"
  echo -e $white"	[$okegreen"6"$white]$cyan http-malware-host	"
  echo -e $white"	[$okegreen"7"$white]$cyan http-virustotal	"
  echo -e $white"	[$okegreen"8"$white]$cyan irc-unrealircd-backdoor	"
...
echo -e $white"	[$okegreen"1"$white]$cyan afp-path-vuln  "
echo -e $white"	[$okegreen"2"$white]$cyan broadcast-avahi-dos "
echo -e $white"	[$okegreen"3"$white]$cyan clamav-exec "
echo -e $white"	[$okegreen"4"$white]$cyan distcc-cve2004-2687 "
echo -e $white"	[$okegreen"5"$white]$cyan dns-update "
echo -e $white"	[$okegreen"6"$white]$cyan firewall-bypass "
echo -e $white"	[$okegreen"7"$white]$cyan ftp-libopie "
echo -e $white"	[$okegreen"8"$white]$cyan ftp-proftpd-backdoor "
echo -e $white"	[$okegreen"9"$white]$cyan ftp-vsftpd-backdoor "
...
function pingbebeb() {
  ...
  echo -e $okegreen"   (_/ alf \_)         "
    echo -e $white " "
    echo -e $white"	[$okegreen"1"$white]$cyan  BROADCAST PING  "
    echo -e $white"	[$okegreen"2"$white]$cyan  TCP SYN PING SCANS "
    echo -e $white"	[$okegreen"3"$white]$cyan  TCP ACK PING SCANS "
    echo -e $white"	[$okegreen"4"$white]$cyan  UDP PING SCANS "
    echo -e $white"	[$okegreen"5"$white]$cyan  ICMP PING SCANS "
...
echo ""
echo ""
  echo -e $white"	[$okegreen"1"$white]$cyan  ITENSE SCAN"
  echo -e $white"	[$okegreen"2"$white]$cyan  ITENSE SCAN + UDP "
  echo -e $white"	[$okegreen"3"$white]$cyan  ITENSE SCAN ALL TCP PORTS "
  echo -e $white"	[$okegreen"4"$white]$cyan  QUICK SCAN  "
  echo -e $white"	[$okegreen"5"$white]$cyan  QUICK SCAN PLUS PLUS "
  echo -e $white"	[$okegreen"6"$white]$cyan  QUICK TRACEROUT   "
...
echo ""
  ...
  echo " -----------------------------------------------------------------------"
  echo ""
    echo -e $white"	[$okegreen"1"$white]$cyan  DETECTING WEB APPLICATION FIREWALLS  "
    echo -e $white"	[$okegreen"2"$white]$cyan  DETECTING POSSIBLE XST VULNERABILITIES "
    echo -e $white"	[$okegreen"3"$white]$cyan  DETECTING OPEN RELAYS "
    echo -e $white"	[$okegreen"4"$white]$cyan  DETECTING BACKDOOR SMTP SERVERS "
    echo -e $white"	[$okegreen"5"$white]$cyan  DETECTING CROSS SITE SCRIPTING VULNERABILITIES  "
    echo -e $white"	[$okegreen"6"$white]$cyan  ENUMERATING USERS IN AN SMTP SERVER "
    echo -e $white"	[$okegreen"7"$white]$cyan  DETECTING WEB SERVERS VULNERABLE TO SLOWLORIS DDOS  "
    echo -e $white"	[$okegreen"8"$white]$cyan  FINDING SQL INJECTION VULNERABILITIES  "
    echo -e $white"	[$okegreen"9"$white]$cyan  CHECK IP GEOLOCATION WITH NSE  "
...
echo -e $okegreen"    =========================================================    ";
		echo -e $white " "
		echo -e $white"	[$okegreen"1"$white]$cyan  REGULER SCAN "
        echo -e $white"	[$okegreen"2"$white]$cyan  SCAN MULTIPLE IP ADDRESS "
		echo -e $white"	[$okegreen"3"$white]$cyan  SCAN OS VERSION AND TRACEROUTE "
        echo -e $white"	[$okegreen"4"$white]$cyan  FIND OUT IF A HOST IS PROTECTED FIREWALL  "
		echo -e $white"	[$okegreen"5"$white]$cyan  EVADING FIREWALLS "
        echo -e $white"	[$okegreen"6"$white]$cyan  PING PING !!   "
        echo -e $white"	[$okegreen"7"$white]$cyan  WEB SERVICES"
		echo -e $white"	[$okegreen"8"$white]$cyan  NMAP SCRIPT ENGINE - ADVANCED   "
		echo -e $white"	[$okegreen"9"$white]$cyan  ADVANCED NMAP SCANNINGS ( ZENMAP COMMAND ) "
    ...
    elif test $RedEyeMap == '6'
      then
      pingbebeb

		elif test $RedEyeMap == '7'
			then
			WebService

		elif test $RedEyeMap == '8'
 			then
 			nse

		elif test $RedEyeMap == '9'
 			then
      zenmapscript

		elif test $RedEyeMap == '10'
	     then
       scanoutput

		elif test $RedEyeMap == '11'
 			then
      credits

    elif test $RedEyeMap == '12'
      then
        clear
				sleep 1
				echo ""
